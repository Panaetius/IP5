...
def read_ip5wke(filename_queue, data_dir):
  """Reads and parses examples from ip5wke data files.
...
def distorted_inputs(data_dir, batch_size):
  ...
  read_input = read_ip5wke(filename_queue, data_dir)
